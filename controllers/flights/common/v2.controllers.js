...
const {
	callPaymentCallback,
} = require('../../infrastructure/payment/paymentCallback.controllers.js')
...
const logsdetailsv2 = async (req, res, next) => {
	try {
		...
		const If_4fcd387b_29f0_4c93_ae3e_64405a74c68b = {
			input: request_9393c709_ef6d_4848_83dc_8425985d816a,
			params: request_9393c709_ef6d_4848_83dc_8425985d816a,
			secrets: process.env,
			headers,
		}
		let externalOutput_4fcd387b_29f0_4c93_ae3e_64405a74c68b
		if (
			If_4fcd387b_29f0_4c93_ae3e_64405a74c68b.params.query.search?.length > 0
		) {
			const checkResponse = async () => {
				const inputData_4fcd387b_29f0_4c93_ae3e_64405a74c68b = {
					...If_4fcd387b_29f0_4c93_ae3e_64405a74c68b,
				}
				delete inputData_4fcd387b_29f0_4c93_ae3e_64405a74c68b.params
				delete inputData_4fcd387b_29f0_4c93_ae3e_64405a74c68b.secrets
				delete inputData_4fcd387b_29f0_4c93_ae3e_64405a74c68b.headers
				const internalOutput_4fcd387b_29f0_4c93_ae3e_64405a74c68b =
					inputData_4fcd387b_29f0_4c93_ae3e_64405a74c68b
				const SQLQuery_a6c14702_b616_41d5_b7cc_77cd6ddec290 = {
					input: internalOutput_4fcd387b_29f0_4c93_ae3e_64405a74c68b,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const output_a6c14702_b616_41d5_b7cc_77cd6ddec290 =
					await prisma.$queryRaw`SELECT * FROM function_a6c14702_b616_41d5_b7cc_77cd6ddec290 (${SQLQuery_a6c14702_b616_41d5_b7cc_77cd6ddec290.params.query.search});`
				const RunJavaScriptCode_1df3c314_af39_4e79_b8df_ecc79115c3a0 = {
					input: output_a6c14702_b616_41d5_b7cc_77cd6ddec290,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0 =
					RunJavaScriptCode_1df3c314_af39_4e79_b8df_ecc79115c3a0

				const runJavascriptCode_1df3c314_af39_4e79_b8df_ecc79115c3a0 =
					async function () {
						if (rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0.input.length > 0) {
							function paginate(input, pageNumber, pageSize) {
								;(pageNumber = pageNumber || 1), (pageSize = pageSize || 10)
								const offset = (pageNumber - 1) * pageSize
								const paginatedData = input.slice(offset, offset + pageSize)
								const totalPages = Math.ceil(input.length / pageSize)
								return {
									count: input.length,
									totalPages,
									pageNumber,
							...
							const sortedData = sortByCreatedAt(
								rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0.input,
								rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0.params.query.order
							)

							const paginatedResult = paginate(
								sortedData,
								rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0.params.query.page,
								rjc_1df3c314_af39_4e79_b8df_ecc79115c3a0.params.query.size
							)
				...
				const output_1df3c314_af39_4e79_b8df_ecc79115c3a0 =
					await runJavascriptCode_1df3c314_af39_4e79_b8df_ecc79115c3a0()
				const ReturnSuccessResponse_385c5eac_2112_47b9_acc7_7be8802df2c0 = {
					output: output_1df3c314_af39_4e79_b8df_ecc79115c3a0,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0 = {
					...ReturnSuccessResponse_385c5eac_2112_47b9_acc7_7be8802df2c0,
				}

				if (
					updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0?.output
						?.responseType === 'xml'
				) {
					delete updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0.headers
					return res
						.set('Content-Type', 'application/xml')
						.send(
							updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0
								.output.data
						)
				}

				delete updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0.params
				delete updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0.secrets
				delete updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0.headers
				...
				if (
					...
					tavaLogger(
						...
						{
							status: 200,
							data: updatedReturnSuccessRes_385c5eac_2112_47b9_acc7_7be8802df2c0,
						},
						templateType
					)
			...
			externalOutput_4fcd387b_29f0_4c93_ae3e_64405a74c68b = resultCheck
			return res.send(resultCheck)
		}
		const If_e6c2c68b_1735_48c2_ba20_48646eb6a6b1 = {
			input: request_9393c709_ef6d_4848_83dc_8425985d816a,
			params: request_9393c709_ef6d_4848_83dc_8425985d816a,
			secrets: process.env,
			headers,
		}
		let externalOutput_e6c2c68b_1735_48c2_ba20_48646eb6a6b1
		if (!If_e6c2c68b_1735_48c2_ba20_48646eb6a6b1.params.query.search) {
			const checkResponse = async () => {
				const inputData_e6c2c68b_1735_48c2_ba20_48646eb6a6b1 = {
					...If_e6c2c68b_1735_48c2_ba20_48646eb6a6b1,
				}
				delete inputData_e6c2c68b_1735_48c2_ba20_48646eb6a6b1.params
				delete inputData_e6c2c68b_1735_48c2_ba20_48646eb6a6b1.secrets
				delete inputData_e6c2c68b_1735_48c2_ba20_48646eb6a6b1.headers
				const internalOutput_e6c2c68b_1735_48c2_ba20_48646eb6a6b1 =
					inputData_e6c2c68b_1735_48c2_ba20_48646eb6a6b1
				const SQLQuery_0e0f80fe_382e_4849_98f1_433c28d42558 = {
					input: internalOutput_e6c2c68b_1735_48c2_ba20_48646eb6a6b1,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const output_0e0f80fe_382e_4849_98f1_433c28d42558 =
					await prisma.$queryRaw`SELECT * FROM function_0e0f80fe_382e_4849_98f1_433c28d42558 ();`
				const RunJavaScriptCode_b196141d_053a_4b2c_9234_bdc3f7ae0cf4 = {
					input: output_0e0f80fe_382e_4849_98f1_433c28d42558,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4 =
					RunJavaScriptCode_b196141d_053a_4b2c_9234_bdc3f7ae0cf4

				const runJavascriptCode_b196141d_053a_4b2c_9234_bdc3f7ae0cf4 =
					async function () {
						if (rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4.input.length > 0) {
							function paginate(input, pageNumber, pageSize) {
							...
							const sortedData = sortByCreatedAt(
								rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4.input,
								rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4.params.query.order
							)

							const paginatedResult = paginate(
								sortedData,
								rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4.params.query.page,
								rjc_b196141d_053a_4b2c_9234_bdc3f7ae0cf4.params.query.size
							)
				...
				const output_b196141d_053a_4b2c_9234_bdc3f7ae0cf4 =
					await runJavascriptCode_b196141d_053a_4b2c_9234_bdc3f7ae0cf4()
				const ReturnSuccessResponse_0cd23e9b_7e35_43f7_8dea_e17854a278ed = {
					output: output_b196141d_053a_4b2c_9234_bdc3f7ae0cf4,
					params: request_9393c709_ef6d_4848_83dc_8425985d816a,
					secrets: process.env,
					headers,
				}
				const updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed = {
					...ReturnSuccessResponse_0cd23e9b_7e35_43f7_8dea_e17854a278ed,
				}

				if (
					updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed?.output
						?.responseType === 'xml'
				) {
					delete updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed.headers
					return res
						.set('Content-Type', 'application/xml')
						.send(
							updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed
								.output.data
						)
				}

				delete updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed.params
				delete updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed.secrets
				delete updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed.headers
				...
				if (
					...
					tavaLogger(
						...
						{
							status: 200,
							data: updatedReturnSuccessRes_0cd23e9b_7e35_43f7_8dea_e17854a278ed,
						},
						templateType
					)
					return finalResponse.length
			...
			const resultCheck = await checkResponse()
			externalOutput_e6c2c68b_1735_48c2_ba20_48646eb6a6b1 = resultCheck
			return res.send(resultCheck)
		}
		return res.json(
		...
		const ReturnErrorResponse_28479f4b_8d1a_4fe7_aa3f_f1443e97780d = {}
		const createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d =
			ReturnErrorResponse_28479f4b_8d1a_4fe7_aa3f_f1443e97780d
		delete createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d.params
		delete createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d.secrets
		delete createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d.headers
		if (!res.headersSent)
			return Object.keys(createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d)
				.length
				? createErrorData_28479f4b_8d1a_4fe7_aa3f_f1443e97780d
				: error
...
const bookcallback_v2 = async (req, res, next) => {
	try {
		const finalResponse = []
		const templateType = 'travel'
		...
		const isPaymentIdExist = await prisma.paymentSession
			.findMany({
				where: {
					paymentId: bookingRequest.query.paymentId,
				},
			})
			.catch((error) => {
				return res
		...
		if (IfPaymentCapturedTrue?.input?.output?.status === 'CAPTURED') {
			const checkResponse = async () => {
											...
											const checkResponse = async () => {
												...
												const tboBookMapper = async function () {
													...
													const callBook = async () => {
														try {
														    const response = await simulateAPICall(bookRequest, 'FLIGHT', 'flightBook') 
															tavaLogger(
																corelationId,
																'Response',
																`${data.secrets.TBO_BASE_URL}/Book?`,
															...
															const checkResponse = async () => {
																...
																const createCancelRequest = async function () {
																	...
																	const body = {
																		...
																		currency:
																			CancelRequest?.params?.query?.currency,
																	}
																	return body
																}
																const flightCancelRequest =
				...
				const flightBookingStatusCheck = async function () {
					let data = bookMapResponse.input

					const addPaymentMethod = (data, paymentCallbackResponse) => {
						return data.map(item => {
							if (item?.output) {
								item.output.paymentMethod = paymentCallbackResponse?.output?.method;
							} else if (item?.externalOutput?.[0]) {
								item.externalOutput[0].paymentMethod = paymentCallbackResponse?.output?.method;
							} else if (item?.timeoutRespone) {
								item.timeoutRespone.paymentMethod = paymentCallbackResponse?.output?.method;
							} else if(item?.response && Array.isArray(item.response) && item.response[0]?.response) {
								item.response[0].paymentMethod = paymentCallbackResponse?.output?.method;
							}
							return item;
						});
					};
				
					data = addPaymentMethod(data, paymentCallbackResponse);
				...
				if (!successResponse.input.error) {
					const checkResponse = async () => {
						...
						const finalRes = await responseProcessor()
		...
		if (IfPaymentCapturedFalse?.input?.output?.status !== 'CAPTURED') {
			const checkResponse = async () => {
				...
				const error = new Error()
				error.statusCode = '400'
				error.message = 'Payment Not Captured ' + ', paymentMethod '  + paymentCallbackResponse?.output?.method;
				throw error
			}
			const resultCheck = await checkResponse()
